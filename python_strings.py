...
## celebration_statement = '{} enjoyed celebrating {}'
## print (birth_year_statement.format(my_first_name,my_last_name,my_year_of_birth))
## print (birth_year_statement.format(my_first_name,my_first_name,my_year_of_birth), celebration_statement.format(my_first_name,current_year))
